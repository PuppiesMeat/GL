...
import com.hs.firstopengl.utils.MatrixHelper
...
//     */
//    private val tableVerticesWithTriangles = floatArrayOf(
//        0f, 0f, 0f, 1.5f, 1f, 1f, 1f,//x,y,z,w,r,g,b
...
//        }
        ...
        /**
         * 这会用45度视野创建一个透视投影。这个视椎体从z值-1的位置开始，在z值为-10的位置结束
         */
        ...
        /**
         * 这就把模型矩阵设为单位矩阵，再沿着z轴平移-2。当我们把空气曲棍球桌子的坐标与这个矩阵相乘时，那些坐标最终会沿着
         * z轴负方向移动2个单位
         */
