 ...
 * @author shun.he
 */
class OffscreenEglContext(var shareContext: EGLContext?) {

    private var mEglDisplay: EGLDisplay? = null
    private var TAG = OffscreenEglContext::class.java.simpleName
    private var mEglConfig: EGLConfig? = null
    private var mEglSurface: EGLSurface? = null
    private var mEglContext: EGLContext? = null
    fun createEglContext(surfaceWidth: Int, surfaceHeight: Int) {
        //initialize display
